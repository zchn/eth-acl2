      ...
      (if (env/has-nextop env)
          (let ((nextop (env/nextop env)))
            (cond ((op/stopp nextop) (exec-stop env))
                  ...
                  ((op/sltp nextop) (exec-slt env))
                  ((op/sgtp nextop) (exec-sgt env))
                  ...
                  ((op/bytep nextop) (exec-byte env))
                  ((op/sha3p nextop) (exec-sha3 env))
                  ((op/addressp nextop) (exec-address env))
                  ((op/originp nextop) (exec-origin env))
                  ...
                  ((op/calldatacopyp nextop) (exec-calldatacopy env))
                  ((op/codesizep nextop) (exec-codesize env))
                  ((op/codecopyp nextop) (exec-codecopy env))
                  ((op/gaspricep nextop) (exec-gasprice env))
                  ((op/extcodesizep nextop) (exec-extcodesize env))
                  ((op/extcodecopyp nextop) (exec-extcodecopy env))
                  ((op/blockhashp nextop) (exec-blockhash env))
                  ((op/coinbasep nextop) (exec-coinbase env))
                  ((op/timestampp nextop) (exec-timestamp env))
                  ((op/numberp nextop) (exec-number env))
                  ((op/difficultyp nextop) (exec-difficulty env))
                  ((op/gaslimitp nextop) (exec-gaslimit env))
                  ((op/popp nextop) (exec-pop env))
                  ...
                  ((op/msizep nextop) (exec-msize env))
                  ((op/gasp nextop) (exec-gas env))
                  ...
                  ((op/createp nextop) (exec-create env))
                  ((op/callp nextop) (exec-call env))
                  ((op/callcodep nextop) (exec-callcode env))
                  ((op/returnp nextop) (exec-return env))
                  ((op/delegatecallp nextop) (exec-delegatecall env))
                  ((op/revertp nextop) (exec-revert env))
                  ((op/invalidp nextop) (exec-invalid env))
                  ((op/selfdestructp nextop) (exec-selfdestruct env))
                  (t (exec-unknown env))))

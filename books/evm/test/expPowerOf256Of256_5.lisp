        ...
        (env/storage/store 
          (env/storage/store 
            (env/storage/store   (mk-initial-env-expPowerOf256Of256_5)
                               6
                               93526145388008191859340524611820427621352466814415752457515217250352065675265)
                             8
                     ...
                     4
                     53133720224321890553799294263499314496700729388928679458153706176025830096639) (cons 'out-of-range "Halted: pc out of range.")))

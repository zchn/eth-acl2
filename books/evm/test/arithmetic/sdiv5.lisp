...
(defun env-with-pre-sdiv5 ()
    (mk-initial-env-sdiv5))

(defun env-with-post-sdiv5 ()
    (env/set-halted 
  (env/storage/store   (mk-initial-env-sdiv5)
                     0
                     57896044618658097711785492504343953926634992332820282019728792003956564819968) (cons 'out-of-range "Halted: pc out of range.")))

(defthm expect-sdiv5
  (expected-env-p (env/exec (env-with-pre-sdiv5))
                  (env-with-post-sdiv5)))
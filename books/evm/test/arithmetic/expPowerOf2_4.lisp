...
(defun mk-initial-env-expPowerOf2_4 ()
  ...
  (mk-env
    ...
    0
    ;; rom
    (mk-rom "600460020a600055600360020a600155600560020a600255")
    ;; stack
    (mk-empty-stack)
    ;; mem
    (mk-empty-memory)
...
(defun env-with-pre-expPowerOf2_4 ()
    (mk-initial-env-expPowerOf2_4))

(defun env-with-post-expPowerOf2_4 ()
    (env/set-halted 
  (env/storage/store 
    (env/storage/store 
